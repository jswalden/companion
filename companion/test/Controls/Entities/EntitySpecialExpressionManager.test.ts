...
describe('EntityPoolSpecialExpressionManager', () => {
	...
	const mockUpdateStoreActionResultTargetFn = vi.fn<UpdateSpecialExpressionValuesFn<'storeActionResultTarget'>>()
	...
	beforeEach(() => {
		...
		manager = new EntityPoolSpecialExpressionManager('control-1', mockCreateVariablesAndExpressionParser, {
			...
			storeActionResultTarget: mockUpdateStoreActionResultTargetFn,
		})
